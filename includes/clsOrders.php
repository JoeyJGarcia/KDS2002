<?php
  ...
  class Order {
    ...
    "\t<SHIP_ADDRESS2><![CDATA[". $this->getAddress2() ."]]></SHIP_ADDRESS2>\n".
    "\t<INTL_PHONE><![CDATA[". $this->getIntlPhone() ."]]></INTL_PHONE>\n".
    "\t<SHIP_CITY><![CDATA[". $this->getCity() ."]]></SHIP_CITY>\n".
    "\t<SHIP_STATE><![CDATA[". $this->getState() ."]]></SHIP_STATE>\n".

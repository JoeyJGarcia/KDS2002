...
<?php echo my_draw_form('process_order_form',my_href_link('process_order2.php','oId='.$_GET['oId']));?>
...
<tr class="tableRowColor">
    ...
    <td align=left class="mediumBoldText" ><?php echo my_draw_spacer('spacer.gif',20,1) .
    stripslashes($order_info['customer_country']); ?>&nbsp;</td>
</tr>
<tr class="tableRowColor">
    <td align=right class="mediumBoldText" >International Phone No.:</td>
    <td align=left class="mediumBoldText" ><?php echo my_draw_spacer('spacer.gif',20,1) .
    stripslashes($order_info['customer_intl_phone']); ?>&nbsp;</td>
</tr>
<tr class="tableRowColor">
...
<tr class="tableRowColorLtYellow">
	...
	<td colspan=3>
<?php
echo "\"" . $order_products['order_product_size'] . "\"  ";
echo "\"" . $product_code . "\"  ";
//echo "\"" . $generic_size . "\"  ";
?>
	</td>
...
<tr class="tableRowColor">
    ...
    <td><?php echo my_draw_pull_down_menu('order_product_size_'.$counter,$arrProductSizes,$order_products['order_product_size']); ?></td>
...
?>
<?php echo my_draw_form('process_order',my_href_link('process_order2.php')) . "\n";?>
...
?>
    <tr class="tableRowColor">
        ...
        <a href="<?php echo my_href_link('process_order2.php', 'action=show_order&oId='.$show_orders['order_id']); ?>" >
...
<br />
<div align="center"><?php echo "<a href=\"". my_href_link('process_order2.php')."\">" . my_image(DIR_WS_IMAGES.'btnBack.gif','Back To Process Menu'); ?></a></div>
...
<?php echo my_draw_form('process_order',my_href_link('process_order2.php', 'action=show_orders'));?>
<br /><br /><br />

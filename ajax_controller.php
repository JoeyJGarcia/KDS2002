...
if($action == "send_email"){
    ...
    echo json_encode($arrResponse);
} elseif ($action == 'acct_folder_create') {
    $arrResponse["status"] = (createAccountFolder($_GET['accounts_number'])) ? 'success' : 'failure';
    echo json_encode($arrResponse);
} elseif ($action == 'acct_folder_delete') {
    $arrResponse["status"] = (deleteAccountFolder($_GET['accounts_number'])) ? 'success' : 'failure';
    echo json_encode($arrResponse);
} else {
    echo "Unknown Action";
}
